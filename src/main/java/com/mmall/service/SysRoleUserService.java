...
public class SysRoleUserService {
    ...
    public List<SysUser> getUserIdListByRoleId(int roleId) {
    ...
    public void updateRoleUsers(int roleId, List<Integer> userIdList) {
        ...
        for (Integer userId : userIdList) {
            SysRoleUser sysRoleUser = SysRoleUser.builder().userId(userId).roleId(roleId).build();
        ...
        sysRoleUserMapper.bathInsert(roleUserList);
        saveRoleUserLog(roleId, originUserIdList, userIdList);
    }
