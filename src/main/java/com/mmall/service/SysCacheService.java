...
public class SysCacheService {
    ...
    public void saveCache(String toSavedValue, int timeoutSecond, CacheKeyConstants prefix, String... keys) {
        ...
        try {
            ...
            log.error("save cache exception:{}, prefix:{}, keys:{} ", e, prefix.name(), JsonMapper.obj2String(keys));
        } finally {
    ...
    public String getFromCache(CacheKeyConstants prefix, String... keys) {
        ...
        try {
            ...
            log.error("get from cache exception:{}, prefix:{}, keys:{} ", e, prefix.name(), JsonMapper.obj2String(keys));
            return null;
        } finally {
            redisPool.safeClose(shardedJedis);
        }
