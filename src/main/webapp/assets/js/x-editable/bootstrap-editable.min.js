...
(function (a) {
    a.fn.editableutils = {
        inherit: function (c, b) {
            ...
            var c = document.body || document.documentElement, f = c.style, g = "transition",
...
(function (c) {
        ...
        init: function (e, d) {
            ...
            if (!c(document).data("editable-handlers-attached")) {
                ...
                c(document).on("click.editable", function (j) {
                    var f = c(j.target), g,
                        h = [".editable-container", ".ui-datepicker-header", ".datepicker", ".modal-backdrop", ".bootstrap-wysihtml5-insert-image-modal", ".bootstrap-wysihtml5-insert-link-modal"];
    ...
    c.fn.editableContainer = function (e) {
        var d = arguments;
        return this.each(function () {
            var h = c(this), j = "editableContainer", g = h.data(j), f = typeof e === "object" && e,
                i = (f.mode === "inline") ? a : b;
            if (!g) {
...
(function (b) {
    ...
    a.prototype = {
        constructor: a, init: function () {
            ...
            var d = this.fillCommon("M"), e, f, h = this.options.template.indexOf("MMMM") !== -1,
                g = this.options.template.indexOf("MMM") !== -1, c = this.options.template.indexOf("MM") !== -1;
            for (f = 0; f <= 11; f++) {
                if (h) {
            ...
            var e = this.fillCommon("h"), f, h, k = this.options.template.indexOf("h") !== -1,
                j = this.options.template.indexOf("H") !== -1,
                d = this.options.template.toLowerCase().indexOf("hh") !== -1, g = k ? 1 : 0, c = k ? 12 : 23;
            for (h = g; h <= c; h++) {
            ...
            var d = this.options.template.indexOf("a") !== -1, e = this.options.template.indexOf("A") !== -1,
                c = [["am", d ? "am" : "AM"], ["pm", d ? "pm" : "PM"]];
            return c
        }, getValue: function (f) {
